...
public class GuiConstants {
	public static final double SCENE_WIDTH = Screen.getPrimary().getVisualBounds().getWidth()*0.8;
	public static final double SCENE_HEIGHT = Screen.getPrimary().getVisualBounds().getHeight()*0.8;
