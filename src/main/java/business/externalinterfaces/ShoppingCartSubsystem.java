...
public interface ShoppingCartSubsystem {
	...
	/**
	 * Used when a user enters Checkout use case by clicking
	 * "Proceed to Checkout" -- at that time rules concerning validity of
	 * shopping cart are run (for instance, user may not have an empty cart)
	 */
