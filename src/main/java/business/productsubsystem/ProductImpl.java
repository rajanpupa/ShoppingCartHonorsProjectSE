...
public class ProductImpl implements Product {
	...
	public ProductImpl(Catalog catalog, Integer productId, String productName, int quantityAvailable, 
			double unitPrice, LocalDate mfgDate, String desc){
        if(productId != null){ this.productId = productId; }
        this.productName=productName;
        this.quantityAvail=quantityAvailable;
        this.unitPrice=unitPrice;
        this.mfgDate=mfgDate;
        this.catalog = catalog;
        Optional.ofNullable(desc).ifPresent(x -> this.description = x);
    }
