...
public class DbClassShoppingCart implements DbClass, DbClassShoppingCartForTest {
    ...
    private void buildSaveCartQuery() {
    	query =  "INSERT INTO shopcarttbl (shopcartid, custid,shipaddress1, " + 
    		...
    		"VALUES (NULL, " + custProfile.getCustId() + ", '" + cart.getShippingAddress().getAddress1() + "', '" + 
    		   cart.getShippingAddress().getAddress2() + "', '"+ cart.getShippingAddress().getCity() + "', '" + cart.getShippingAddress().getState() + "', '" +
    		   cart.getShippingAddress().getZip() + "', '" + cart.getBillingAddress().getAddress1() + "', '" + 
    		   cart.getBillingAddress().getAddress2() + "', '" + cart.getBillingAddress().getCity() + "', '" + cart.getBillingAddress().getState() + "', '" +
